...
class NoteTest(APITestCase):
    ...
    def test_note_create_valid(self, title="test title"):
        ...
        response = self.auth_client.post(self.url_list_create, data)
    ...
    def test_note_comment_create_valid(self):
        ...
        data = {"note": note_id, "content": "test content"}

        response = self.auth_client.post(self.url_comment_create, data)
